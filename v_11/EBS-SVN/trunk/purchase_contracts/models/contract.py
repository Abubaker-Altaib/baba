...
class purchase_contract(models.Model):
    ...
    pricelist_id = fields.Many2one('product.pricelist', 'Pricelist', help="Pricelist for current supplier",
                                   readonly=True, states={'draft': [('readonly', False)]})
    currency_id = fields.Many2one('res.currency', 'Currency', index=1, readonly=True,
                                  states={'draft': [('readonly', False)]})
    ...
    contract_with = fields.Selection([('internal', 'Local Supplier'), ('foreign', 'Foreign Supplier')],
