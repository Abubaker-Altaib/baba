...
class StrategicVisions(models.Model):
    _name = "strategic.visions"
    _description = "Strategic Visions"
    _order = "sequence"
    ...
    _sql_constraints = [
        ('code_Visions_uniq', 'unique (code,company_id)', _('Visions Code Must Be Unique Per Company.')),
    ]
