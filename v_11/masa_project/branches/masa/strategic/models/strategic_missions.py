...
class StrategicMission(models.Model):
    _name = "strategic.mission"
    _description = "Strategic Mission"
    _order = "sequence"
    ...
    _sql_constraints = [
        ('code_Mission_uniq', 'unique (code,company_id)', _('Mission Code Must Be Unique Per Company.')),
    ]
