...
class StrategicValues(models.Model):
    _name = "strategic.values"
    _description = "Strategic Values"
    _order = "sequence"
    ...
    _sql_constraints = [
        ('code_Values_uniq', 'unique (code,company_id)', _('Values Code Must Be Unique Per Company.')),
    ]
