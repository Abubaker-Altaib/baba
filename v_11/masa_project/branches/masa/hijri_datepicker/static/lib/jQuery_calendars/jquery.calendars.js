...
(function($) { // Hide scope, no $ conflict
	...
	$.extend(CDate.prototype, {
		...
		g_week_day: function() {
			return this._calendar.g_week_day(this);
		},
	...
	$.extend(BaseCalendar.prototype, {
		...
		dayOfWeek: function(year, month, day) {
			...
			//////////console.log("...........% this.daysInWeek().",(Math.floor(this.toJD(date)) + 2 )) ;
			//////////console.log("...........% this.daysInWeek().",(Math.floor(this.toJD(date)) + 2 % this.daysInWeek())) ;
			return g_week_day($.ummalquraDataOr[year+'-'+month+'-'+day+'g']);
			return (Math.floor(this.toJD(date)) + 2) % this.daysInWeek();
		},

		g_week_day: function(jd) {
			
			var val = '';
			$.each($.ummalquraDataOr, function(key,value) {
				if(value == jd && key[key.length -1] == 'g'){
					val = key;
				}
			});
		...
		isValid: function(year, month, day) {
			...
			if (valid) {
				...
				////////console.log("valid.................",year, month, day);
	...
	$.extend(GregorianCalendar.prototype, {
		...
		toJD: function(year, month, day) {
			...
			////////////console.log($.ummalquraDataOr[year+'-'+month+'-'+day+'g']);
			return $.ummalquraDataOr[year+'-'+month+'-'+day+'g'];
