...
(function($) { // Hide scope, no $ conflict
 ...
 $(selector).datepick('setDate', [date1, date2, date3]) */
		...
		showMonth: function(elem, year, month, day) {
			//////////console.log(".............showMonth", year, month, day);
			var inst = this._getInst(elem);
		...
		retrieveDate: function(elem, target) {
			var inst = this._getInst(elem);
			////////console.log("...............target", target.className.replace(/^.*jd(\d+).*$/, '$1') );
			return ($.isEmptyObject(inst) ? null : inst.options.calendar.fromJD(
				parseInt(target.className.replace(/^.*jd(\d+).*$/, '$1'))));
		},
		...
		_generateContent: function(elem, inst) {
			...
			for (var row = 0; row < monthsToShow[0]; row++) {
				...
				for (var col = 0; col < monthsToShow[1]; col++) {
					////////console.log("drawDate.year(),drawDate.month()",drawDate.year(),drawDate.month());
		...
		_generateMonth: function(elem, inst, year, month, calendar, renderer, first) {
			//////////console.log("...........jd",elem, inst, year, month, calendar, renderer, first);
			...
			//////////console.log("...........fixedWeeks",fixedWeeks);
			...
			//////////console.log("...........leadDays",leadDays);
			var numWeeks = (fixedWeeks ? 6 : Math.ceil((leadDays + daysInMonth) / calendar.daysInWeek()));

			//////////console.log("...........numWeeks",numWeeks);
			var selectOtherMonths = inst.options.selectOtherMonths && inst.options.showOtherMonths;

			//////////console.log("...........selectOtherMonths",selectOtherMonths);
			...
			//////////console.log("...........showWeeks",showWeeks);
			var today = calendar.today();

			////////console.log("...........today",year, month, calendar.minDay);
			...
			for (var week = 0; week < numWeeks; week++) {
				...
				for (var day = 0; day < calendar.daysInWeek(); day++) {
					...
					days += this._prepare(renderer.day, inst).replace(/\{day\}/g,
						...
						' class="jd' + calendar.newDate(year, month, drawDate.day()).toJD() + ' ' + (dateInfo.dateClass || '') +
		...
		_generateMonthSelection: function(inst, year, month, minDate, maxDate, monthHeader, calendar) {
			...
			if (yearRange === 'any') {
				...
				////////console.log(start.toJD() , end.toJD());
				if (start < end) {
