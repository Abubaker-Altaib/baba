...
class AccountVoucher(models.Model):
    ...
    account_analytic_id = fields.Many2one(related='department_id.analytic_account_id', string='Analytic Account')
...
class Accountvoucherpriority(models.Model):
    ...
    active = fields.Boolean(default=True, help="Set active to false to hide the priority without removing it.")
