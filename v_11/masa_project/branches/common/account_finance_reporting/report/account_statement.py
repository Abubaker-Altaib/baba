...
class ReportAccountStatement(models.AbstractModel):
    _name = 'report.account_finance_reporting.report_account_statement'
    ...
    def get_report_values(self, docids, data=None):
        ...
        account_res = self.with_context(data['form'].get('used_context'))._get_account_move_entry(accounts, init_balance, sortby, account_id)
