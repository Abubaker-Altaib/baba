...
class ZakatResCompany(models.Model):
    ...
    property_basal_draining_stock_id = fields.Many2one('stock.warehouse',string="Basal Drainage Stock",company_dependent=True)
...
class ZakatSettings(models.TransientModel):
    ...
    def onchange_company_id(self):
        ...
        self.property_basal_draining_stock_id = company.property_basal_draining_stock_id
    ...
    def set_company_values(self):
        ...
        company.property_basal_draining_stock_id = company.property_basal_draining_stock_id
