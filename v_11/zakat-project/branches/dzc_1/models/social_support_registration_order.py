    ...
    def done_action(self):
        ...
        if self.type == 'new':
            for fageer in self.fageer_ids:
                fageer.fageer_new_id.s_support = True
                fageer.fageer_new_id.status = fageer.status
                fageer.fageer_new_id.social_amount = fageer.amount
            ...
            for fageer in self.fageer_ids:
                ...
                fageer.fageer_old_id.s_support = False
                fageer.fageer_old_id.status = False
                fageer.fageer_old_id.social_amount = 0.0
