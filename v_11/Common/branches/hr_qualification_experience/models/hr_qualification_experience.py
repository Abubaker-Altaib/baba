...
class EmployeeQualification(models.Model):
    ...
    degree_id = fields.Many2one('hr.recruitment.degree', "Qualification", ondelete="cascade",required=True,states={'validated': [('readonly', True)]})
...
class RecruitmentDegree(models.Model):
    ...
    sequence = fields.Integer("Sequence", default=1, help="Gives the sequence order when displaying a list of degrees.",required=True)
...
class EmployeExperience(models.Model):
    ...
    employee_id = fields.Many2one('hr.employee','Employee',required=True,states={'validated': [('readonly', True)]})
    categ_id = fields.Many2one("hr.applicant.category" ,required=True, string="Job Category", readonly=True, states={'draft':[('readonly',False)]})
