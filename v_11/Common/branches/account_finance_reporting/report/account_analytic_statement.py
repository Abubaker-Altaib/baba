...
class ReportAnalyticStatement(models.AbstractModel):
    ...
    def _get_account_move_entry(self, accounts, init_balance, sortby, analytic_account_id):
        """
        :param:
    ...
    def get_report_values(self, docids, data=None):
        ...
        account_res = self.with_context(data['form'].get('used_context'))._get_account_move_entry(accounts, init_balance, sortby, analytic_account_id)
