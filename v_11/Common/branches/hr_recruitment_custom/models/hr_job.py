...
class Job(models.Model):
    ...
    categ_id = fields.Many2one("hr.applicant.category", string="Job Category", readonly=True, states={'draft':[('readonly',False)]})
    ...
    degree_ids = fields.Many2many("hr.recruitment.degree", string="Degrees", readonly=True, states={'draft':[('readonly',False)]})
