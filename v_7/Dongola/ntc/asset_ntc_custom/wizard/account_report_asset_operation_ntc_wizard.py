    ...
    def check_report(self, cr, uid, ids, context=None):
        ...
        if data['form']['asset_lists'] == 'details':
            return {'type': 'ir.actions.report.xml',\
                    'report_name': 'account.assets.details.ntc.report',\
                    'datas': data}
        if data['form']['asset_lists'] == 'end_of_year':
            return {'type': 'ir.actions.report.xml',\
                    'report_name': 'account.assets.end_of_year_ntc.report',\
                    'datas': data}
        if data['form']['asset_lists'] == 'depreciation':
            return { 'type': 'ir.actions.report.xml', 'report_name': 'account.asset.Depr.ntc', 'datas': data}
        if data['form']['asset_lists'] == 'revalue' or data['form']['asset_lists'] == 'initial' or data['form']['asset_lists'] == 'abandon' or data['form']['asset_lists'] == 'sale' or data['form']['asset_lists'] == 'list':
             return { 'type': 'ir.actions.report.xml', 'report_name': 'account.asset.operation.ntc3', 'datas': data}        
        if data['form']['asset_lists'] == 'before_revalue' or data['form']['asset_lists'] == 'after_revalue' or data['form']['asset_lists'] == 'before_rehab' or data['form']['asset_lists'] == 'after_rehab':
             return { 'type': 'ir.actions.report.xml', 'report_name': 'account.asset.operation.ntc', 'datas': data}        
        return {'type': 'ir.actions.report.xml', 'report_name': 'account.asset.operation.ntc', 'datas': data}
