...
class bonus_listing_report(report_sxw.rml_parse):
	...
	#deduct_ids.reverse()
        ...
        names_line += [u'إجمالي السلفيات',u'الدمغة',u'الضريبة', u'الاستحقاقات',u'الاسم']
...
report_sxw.report_sxw('report.bonus_listing.report', 'hr.payroll.main.archive', 'addons/hr_ntc_custom/report/bonus_listing.mako' ,parser=bonus_listing_report)
