...
# # # # # # #  '1' Cost Center Details  # # # # # # #
    ...
    def get_budget_line_view(self, form, child_ids):
        ...
        self.cr.execute("select general_account_id as acc_id from account_budget_lines where account_budget_id in (%s) " % (budget_ids,))  
        ...
        for code in account_ids2:
            account_consol_id = self.pool.get('account.account').search(self.cr, self.uid, [('code', '=', code),('company_id','=',company_id)], context=self.context)
