...
class AccountReportBudgetWizard(osv.osv_memory):
    ...
    _columns = {
        ...
        'type_rep':fields.selection([('income','Income'),('cost','Cost'),('asset','Asset')],required=1,string='Root Select')
}
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        if summary and res['datas']['form']['type_selection']=='planned':
            res['report_name'] = 'account.budget.planned'
        if summary and res['datas']['form']['type_selection']=='state':
            res['report_name'] = 'account.budget.state'
        if summary and res['datas']['form']['type_selection']=='sub':
            res['report_name'] = 'account.budget.sub'
        return res
