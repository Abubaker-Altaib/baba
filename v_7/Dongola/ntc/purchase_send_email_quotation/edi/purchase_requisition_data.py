...
Purchase_Requisition_LINES_EDI_STRUCT = {
    'name': True,
    #custom: 'date_planned'
    'product_id': True,
    'product_uom_id': True,
...
Purchase_Requisition_EDI_STRUCT = {
    'name': True,
    'origin': True,
    ...
    #custom: 'notes'
    'line_ids': Purchase_Requisition_LINES_EDI_STRUCT,
...
class purchase_requisition(osv.osv, EDIMixin):
    _inherit = 'purchase.requisition'
 
    def edi_export(self, cr, uid, records, edi_struct=None, context=None):
        """Exports a Purchase Requisition"""
        edi_struct = dict(edi_struct or Purchase_Requisition_EDI_STRUCT)
        ...
        for order in records:
            ...
            edi_doc = super(purchase_requisition,self).edi_export(cr, uid, [order], edi_struct, context)[0]
            edi_doc.update({
                    # force trans-typing to purchase.order upon import
                    '__import_model': 'purchase.requisition',
...
class purchase_requisition_line(osv.osv, EDIMixin):
    ...
    def edi_export(self, cr, uid, records, edi_struct=None, context=None):
        ...
        edi_struct = dict(edi_struct or Purchase_Requisition_LINES_EDI_STRUCT)
        edi_doc_list = []
        for line in records:
            edi_doc = super(purchase_requisition_line,self).edi_export(cr, uid, [line], edi_struct, context)[0]
            edi_doc['__import_model'] = 'purchase.requisition.line'
