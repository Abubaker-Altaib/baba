...
class hr_sign_in_out(osv.osv_memory):
    ...
    _columns = {
        'name': fields.char('Employees name', size=32, required=True, readonly=True),
        'availability': fields.char('Current availability', size=32, required=True, readonly=True),
    ...
    def _get_empid(self, cr, uid, context=None):
        ...
        if emp_id:
            ...
            return {'name': employee.name, 'availability': employee.availability, 'emp_id': emp_id[0]}
        return {}
