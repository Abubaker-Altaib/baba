...
report_sxw.report_sxw('report.payroll.budget', 'hr.payroll.main.archive', 'addons/hr_ntc_custom/report/payroll_budget_report.rml' ,parser=payroll_report, header=False)
