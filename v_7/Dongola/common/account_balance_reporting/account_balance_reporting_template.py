...
class account_balance_reporting_template(osv.Model):
    ...
    _columns = {
        ...
        'rml': fields.selection([('1','Debit/Credit'),('2','Amount - Debit/Credit'),('3','Move Without Details'),('4','Move With Details'),('5','Tow Years Comparison'),('6','Balance Sheet'),('7','trial balance')], 'RML', required=True),
...
class account_balance_reporting_template_line(osv.Model):
    ...
    _columns = {
        ...
        'debit': fields.text('Debit', digits=(16,2)),
        'credit': fields.text('Credit', digits=(16,2)),
        ...
        'disclosure_number': fields.char('Disclosure Number'),
        'color': fields.selection([('white','white'),('gray','gray')], 'color'),
        'show':fields.boolean('Show Total'),
...
class account_balance_reporting_template_sequence(osv.Model):
    ...
    def _check_sequence(self, cr, uid, ids, context=None):
        """
        Constraint method check that sequence value is unique and between 1 & 8
    ...
    #CHECKME: add unique & check sql_constraint instead of _check_sequence
    _constraints = [
