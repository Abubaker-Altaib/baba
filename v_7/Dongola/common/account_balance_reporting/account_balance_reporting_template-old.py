...
class account_balance_reporting_template(osv.Model):
    ...
    _columns = {
        ...
        'rml': fields.selection([('1','Debit/Credit'),('2','Amount - Debit/Credit'),('3','Move Without Details'),('4','Move With Details'),('5','Tow Years Comparison'),('6','Balance Sheet')], 'RML', required=True),
