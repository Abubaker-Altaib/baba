...
class account_analytic_balance(osv.osv_memory):
    """
    Wizard that display debit, credit & balance values for analytic accounts between the selected dates.
    Calculation from journal items instead of analytic journal items
    """
    ...
    def check_report(self, cr, uid, ids, context=None):
        ...
        return {
            ...
            'report_name': 'account.analytic.account.balance1',
            'datas': datas,
            }
