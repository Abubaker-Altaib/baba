...
class account_balance_all(report_sxw.rml_parse, common_header, custom_common_header):
    _name = 'report.account.account.all.balance'

    def __init__(self, cr, uid, name, context=None):
        super(account_balance_all, self).__init__(cr, uid, name, context=context)
        self.sum_debit = 0.00
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(account_balance_all, self).set_context(objects, data, new_ids, report_type=report_type)
...
report_sxw.report_sxw('report.account.account.balance.all.arabic', 'account.account', 'addons/account_arabic_reports/report/account_balance_all.rml', parser=account_balance_all , header=True)
