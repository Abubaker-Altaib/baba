...
report_sxw.report_sxw('report.account.reconcile.statement', 'account.bank.statement', 'addons/account_arabic_reports/report/account_reconcile_statement.rml', parser=account_statement, header='internal landscape')
