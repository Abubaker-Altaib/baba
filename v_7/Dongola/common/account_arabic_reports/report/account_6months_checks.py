...
report_sxw.report_sxw('report.account.6months.checks.arabic', 'account.move.line', 'addons/account_arabic_reports/report/account_6months_checks.rml', parser=account_6months_checks, header='internal landscape')
