...
class common_report_header(object):
    ...
    def _get_multi_company(self, data, account_id):
        """
        @return: char company name for accounts that are not belong to the selected chart of account company
        """
    ...
    def get_start_period_br(self, data):
        """
        @return: browse record for the selected period_from
        """
    ...
    def get_end_period_br(self, data):
        """
        @return: browse record for the selected period_to
        """
    ...
    def _get_display_account(self, data):
        """
        @return: char meaning full translated term for the selected display_account 
        """
    ...
    def _get_display_partner_account(self, data):
        """
        @return: char meaning full translated term for the selected result_selection 
        """
    ...
    def _get_display_target_move(self, data):
        """
        @return: char meaning full translated term for the selected target_move 
        """
    ...
    def _get_filter(self, data):
        """
        @return: char meaning full term for the selected filter 
        """
    ...
    def _get_filter_Trans(self, data):
        """
        @return: char meaning full translated term for the selected filter 
        """
    ...
    def _get_sortby_gl(self, data):
        """
        @return: char meaning full translated term for the selected sortby 
        """
    ...
    def _get_move(self, data):
        """
        @return: value of moves field which entered in wizard form
        """
        return self._get_form_param('moves', data)

    def _get_just_balance(self, data):
        """
        @return: value of acc_balances field which entered in wizard form
        """
        return self._get_form_param('acc_balances', data)

    def _get_initial_balance(self, data):
        """
        @return: value of initial_balance field which entered in wizard form
        """
        return self._get_form_param('initial_balance', data)

    def _get_amount_currency(self, data):
        """
        @return: value of amount_currency field which entered in wizard form
        """
        return self._get_form_param('amount_currency', data)

    def _get_date_from(self, data):
        """
        @return: char date_from value which entered in wizard form
        """
    ...
    def _get_date_to(self, data):
        """
        @return: char date_to value which entered in wizard form
        """
    ...
    def _get_form_param(self, param, data, default=False):
        """
        @return: the value of given param which entered in wizard form
        """
        return data.get('form', {}).get(param, default)

    def _get_form_param_translate(self, param, data, default=False):
        """
        @return: the translated term of value of given param which entered in wizard form
        """
    ...
    def get_all_accounts(self, account_ids, filter_view=False, filter_type=None, context=None):
        """
        Get all account passed in params with their children
        """
        context = context or {}
        accounts = []
    ...
    def _get_period_range_form_periods(self, start_period, stop_period, mode):
        """
        Method to get all periods between the start & stop period including the start & stop periods
    ...
    def _get_period_range_form_start_period(self, start_period, include_opening=False,
        ...
        """
        @return: list of IDs, all periods before the start period
        """
    ...
    def _compute_init_balance(self, account, period_ids, mode='computed'):
        """
        Method to compute initial balance for the given account into the given periods
    ...
    def _compute_inital_balances(self, account_ids, start_period, fiscalyear, main_filter):
        """
        Method to compute initial balance.
        ...
        @return: list of dictionaries {account id: {init_balance: amount, init_balance_currency: amount, state}}"""
    ...
    def _get_move_ids_from_periods(self, account_id, period_start, period_stop, mode, valid_only=False):
        """
        @return: list of move line ids according to the given filters
        """
    ...
    def get_move_lines_ids(self, account_id, main_filter, start, stop, mode='include_opening', valid_only=False):
        ...
        @return: list of move line ids or raise exception
        """
    ...
    def _get_move_line_datas(self, move_line_ids, order='l.date ASC, per.special DESC, per.date_start ASC, m.name ASC'):
        """
        @return: dictionary move lines data
        """
    ...
    def _get_moves_counterparts(self, move_ids, account_id, limit=3):
        """
        Method to get codes of all accounts participate in the given moves 
        
        @return: dictionary {move_id: account codes}
        """
        if not move_ids:
            return {}
        if not isinstance(move_ids, list):
            move_ids = [move_ids]
        sql = """SELECT account_move.id,
                           array_to_string(
    ...
    def _get_Translation(self, data):
        """
        @return: char translated term
        """
        return _(data)

    def _get_journal(self, data):
        """
        @return: list of journals codes
        """
        codes = []
    ...
    def _get_company(self, data):
        """
        @return: char the selected chart of account company name
        """
        return self._get_chart_account_id_br(data).company_id.name

    def _get_currency(self, data):
        """
        @return: char the selected chart of account company currency symbol 
        """
        return self._get_chart_account_id_br(data).company_id.company_id.currency_id.symbol

    def _sum_debit_period(self, period_id, journal_id=None):
        """
        Method to calculate the summation of  debit move line for the given journal in the given period
        
        @return float debit summation
        """
    ...
    def _sum_credit_period(self, period_id, journal_id=None):
        """
        Method to calculate the summation of  credit move line for the given journal in the given period
        
        @return float credit summation
        """
        journals = journal_id or self.journal_ids
        if not journals:
            return 0.0
    ...
    def _get_children_and_consol(self, cr, uid, ids, module, context=None):
        """
        Method that search for all the children and all consolidated children (recursively) of the given account ids
