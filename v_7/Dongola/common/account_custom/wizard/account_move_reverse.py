...
class account_move_reverse(osv.TransientModel):
    ...
    _columns = {
         'journal_id': fields.many2one('account.journal', 'Journal', required=True , help='Journal for the reversion move'),
        'period_id': fields.many2one('account.period', 'Move Period', required=True, help='Period for the reversion move'),
