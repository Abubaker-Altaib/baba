...
class stock_fill_inventory(osv.osv_memory):
    ...
    def fill_inventory(self, cr, uid, ids, context=None):
        ...
        if context.get('active_id', False):
            to_date = self.pool.get('stock.inventory').browse(cr, uid, context.get('active_id', False)).date
        ...
        for location in location_ids:
            datas = {}
            res[location] = {}
            move_ids = move_obj.search(cr, uid, ['|',('location_dest_id','=',location),('location_id','=',location),('state','=','done'),('date','<=',to_date)], context=context)
