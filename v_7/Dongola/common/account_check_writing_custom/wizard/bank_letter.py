...
class wizard_bank_letter(osv.osv_memory):
    """
    Wizard to print bank transfer letter to partner
    """
    _name = 'wizard.bank.letter'
    
    def _get_journal(self, cr, uid, context=None):
        """
        @return: char current voucher journal name
        """
    ...
    def act_bank_letter(self, cr, uid, ids, context=None):
        ...
        voucher_pool.write(cr, uid, [voucher.id],{'chk_seq':'Bank Letter', 'chk_status':True},context=context)
