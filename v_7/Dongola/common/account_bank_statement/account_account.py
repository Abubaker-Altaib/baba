...
class res_company(osv.Model):
    """
    Inherit company model to add ability of defining the equation used in bank reconciliation 
    by the specific company & which field the equation result should be equal  
    """
