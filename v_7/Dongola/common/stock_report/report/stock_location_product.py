...
report_sxw.report_sxw('report.stock.location.product2', 'product.product', 'addons/stock_report/report/stock_location_product.rml' ,parser=stock_location_product_reports ,header='internal landscape')
