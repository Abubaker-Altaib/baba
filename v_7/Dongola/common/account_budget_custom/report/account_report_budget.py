...
# # # # # # #  '1' Cost Center Details  # # # # # # #
    ...
    def get_budget_line(self, form, budget_id):
        globals()['total_plan'] = 0
        globals()['total_operation'] = 0
        globals()['total_balance'] = 0
        globals()['total_residual_balance'] = 0
        ...
        for line in bud.account_budget_line:
            ...
            budget.append({'accounts_name':line.general_account_id.name,
            'accounts_code':line.general_account_id.code,
            ...
            globals()['total_residual_balance'] += residual_balance
        return budget

    def _budget_total(self):
        total = {'planned_amount':0.0, 'total_operation':0.0,'balance':0.0, 'residual_balance':0.0}
        total['planned_amount'] = globals()['total_plan']
        total['total_operation'] += globals()['total_operation']
        #total['confirm'] += 'confirm' in budget_line_pool._columns and line.confirm or 0.0
        total['balance'] += globals()['total_balance']
        total['residual_balance'] += globals()['total_residual_balance']
        return [total]
