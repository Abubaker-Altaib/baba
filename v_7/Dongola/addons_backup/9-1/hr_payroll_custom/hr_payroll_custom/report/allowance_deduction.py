    ...
    def total_salary(self, data):
        if data['form']['by']=='allow' and data['form']['type']!='deduct':
            self.cr.execute(
                ...
                WHERE pm.company_id in %s and pm.month =%s and pm.year =%s and pm.in_salary_sheet =%s ''',(tuple([data['form']['company_id'][0]]) ,data['form']['month'],data['form']['year'],data['form']['in_salary_sheet'],)) 
