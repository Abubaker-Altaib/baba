...
report_sxw.report_sxw('report.statistics_emps', 'hr.employee', 'hr_payroll_custom/report/static_emps_by_dep.mako' ,parser=statistics_emps,header="internal landscape")
