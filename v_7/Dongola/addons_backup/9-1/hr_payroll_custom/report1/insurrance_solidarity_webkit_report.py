...
report_sxw.report_sxw('report.insurrance.solidarity.webkit', 'hr.payroll.main.archive', 'hr_payroll_custom/report/insurrance_solidarity_webkit_report.mako', parser=insurrance_solidarity_webkit, header=True)
