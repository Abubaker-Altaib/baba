...
class hr_employee_salary_addendum(osv.Model):
    ...
    def days_calculation(self, cr, uid,ids ,  employee,paroll_date, emp_holidays=[] ,emp_delegations=[],context={}):
        ...
        if emp_holidays:
            for emp_hol in emp_holidays:
                ...
                if emp_hol['type'] == 'customized' and not emp_hol['include_basic'] : 
                    days -= emp_hol['days']
        ...
        return {'days':days,'customized_allow_deduct':customized_allow_deduct, 'basic_salary':basic_salary ,'hol_type' : hol_type , 'linked_absence_days':linked_absence_days}
    ...
    def compute(self, cr, uid, ids, context = {}):
        ...
        allow_linked_absence_ids = allows_obj.search(cr , uid , [('linked_absence' , '=' , True)])
        allow_linked_absence_list = allows_obj.read(cr , uid , allow_linked_absence_ids , ['id' , 'holiday_ids'])
       ...
       # main_arch_obj.create_main_archive(cr, uid, \
        ...
        for employee in employee_obj.browse(cr, uid, data['employee_ids'], context = context):
            ...
            if data['type'] == 'salary': 
                ...
                if days <= 0 and result['hol_type'] == "unpaied":
                    continue
    ...
    def _get_leave_status(self, cr, uid, ids, employee_ids , month, year,allow_linked_absence={}):
        ...
        for r in res :
            ...
            if r['type'] == 'customized':
                emp_data.update({
                    'allow_deduct_ids' : [rec.id for rec in status_obj.browse(cr, uid, r['status_id']).allow_deduct_ids]
                    })
            linked_absence_days = 0
