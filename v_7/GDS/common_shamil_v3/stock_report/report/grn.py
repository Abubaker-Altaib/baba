...
class grn_report(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(grn_report, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.grn.report', 'stock.picking', 'addons/stock_report/grn.rml' ,parser=grn_report )
