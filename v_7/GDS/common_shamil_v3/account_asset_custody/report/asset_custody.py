...
class asset_custody_sum_reports(report_sxw.rml_parse):
    ...
    def _get_filters(self,data):
        ...
        office_obj = self.pool.get('hr.employee') 
    ...
    def _get_data(self,data):
        ...
        if data['form']['executing_agency']:
           res=[x for x in res if x['executing_agency']==data['form']['executing_agency']]
        ...
        if data['form']['product_id']:
           res=[x for x in res if x['model_id']==data['form']['product_id'][0]]
        if data['form']['cat_id']:
        ...
        if data['form']['employee_id']:
           res=[x for x in res if x['emp_id'] == data['form']['employee_id'][0]]
        #if data['office_ids']:
