...
report_sxw.report_sxw('report.account.account.budget.operation.history.report', 'account.budget.operation.history', 'account_budget_custom/report/account_report_budget_operation_history_report.rml', parser=account_budget_operation_history, header='custom landscape')
