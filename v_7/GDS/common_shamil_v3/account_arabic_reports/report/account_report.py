...
class report_account_receivable(osv.Model):
...
class report_aged_receivable(osv.Model):
...
class report_invoice_created(osv.Model):
...
class report_account_type_sales(osv.Model):
...
class report_account_sales(osv.Model):
