...
report_sxw.report_sxw('report.account.journal.period.print.arabic', 'account.journal.period', 'addons/account_arabic_reports/report/account_journal.rml', parser=journal_print, header='custom landscape')
