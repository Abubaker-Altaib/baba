...
report_sxw.report_sxw('report.credit.note.payment.niss', 'account.voucher', 'addons/account_voucher_custom/report/account_credit_note_payment.rml', parser=report_credit_note_niss,header=False )
