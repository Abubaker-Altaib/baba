...
class report_cash_reciept(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(report_cash_reciept, self).__init__(cr, uid, name, context)
...
report_sxw.report_sxw('report.cash.reciept', 'account.voucher', 'addons/account_voucher_custom/report/account_cash_reciept.rml', parser=report_cash_reciept,header='external' )
