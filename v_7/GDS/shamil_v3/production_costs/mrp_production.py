...
class mrp_production(osv.osv):
    ...
    def _calculate_emps_cost(self, cr, uid, ids, name, args, context=None):
        """
	Functional field method that calculates the total amount of employee cost.	        
	...
	@param args: other arguments
        ...
        for rec in self.browse(cr, uid, ids, context=context):
            result[rec.id]=sum([line.employee_cost for line in rec.production_manpower if rec.production_manpower])
        return result
    ...
    _columns = {
        ...
        'emps_cost':fields.function(_calculate_emps_cost, string='Labor Cost', type='float', method=True, readonly=True, 
					store={
					'mrp.production': (lambda self, cr, uid, ids, c={}: ids, ['production_manpower'], 10),
