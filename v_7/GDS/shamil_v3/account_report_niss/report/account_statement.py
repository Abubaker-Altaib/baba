...
report_sxw.report_sxw('report.account.account.statement.detailed.inherit', 'account.account', 'addons/account_report_niss/report/account_statement_detailed.rml', parser= account_statement_total, header=False)

report_sxw.report_sxw('report.account.account.statement.total.inherit', 'account.account', 'addons/account_report_niss/report/account_statement_total.rml', parser =  account_statement_total, header=True)
