...
report_sxw.report_sxw('report.account.trial.balance', 'account.account', 'addons/account_report_niss/report/account_report_trial_balance.rml', parser =  account_trial_balance, header=True)
