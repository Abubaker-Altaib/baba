...
report_sxw.report_sxw('report.account.statement.detailed.inherit', 'account.account', 'addons/account_report_niss/report/account_statement_detailed_inherit.rml', parser=account_statement, header=False)
