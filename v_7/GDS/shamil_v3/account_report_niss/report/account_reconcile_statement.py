...
report_sxw.report_sxw('report.account.reconcile.statement.reportt.inherit', 'account.bank.statement', 'account_report_niss/report/account_reconcile_statement.rml', parser=account_statement, header=True)
