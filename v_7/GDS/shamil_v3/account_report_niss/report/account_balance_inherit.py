...
report_sxw.report_sxw('report.account.balance.arabic.inherit', 'account.account', 'addons/account_report_niss/report/account_balance.rml', parser=account_balance , header=True)
