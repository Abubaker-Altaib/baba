...
class im_certificate_report(osv.osv_memory):
    _name = "im.certificate.report"
    _description = "IM Certificate Report"
    ...
    _columns = {
        ...
        'request_clearance_ids': fields.many2many('purchase.clearance','request_im_certificate_wizard_rel','counter','request_id', string='Requests'), 
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        return {
            ...
            'report_name': 'im_certificate_report',
            'datas': datas,
            }
