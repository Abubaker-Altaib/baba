...
class customs_fee_letter_report(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(customs_fee_letter_report, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.customs_fee_letter_report', 'purchase.clearance', 'purchase_clearance_niss/report/customs_fee_letter_report.rml', parser=customs_fee_letter_report,header=False)
