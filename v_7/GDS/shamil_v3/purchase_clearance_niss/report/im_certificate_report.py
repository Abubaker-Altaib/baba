...
class im_certificate_report(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(im_certificate_report, self).__init__(cr, uid, name, context=context)
    ...
    def get_data(self,data):
           ...
           self.cr.execute( """
                                    select                        
                                                    ...
                                                    cl.origin_country as origin_country 
...
report_sxw.report_sxw('report.im_certificate_report', 'purchase.clearance', 'purchase_clearance_niss/report/im_certificate_report.rml', parser=im_certificate_report,header=False)
