...
class stock_cooperative_incoming_shippments_report(report_sxw.rml_parse):
      def __init__(self, cr, uid, name, context):
        super(stock_cooperative_incoming_shippments_report, self).__init__(cr, uid, name, context)
...
report_sxw.report_sxw('report.cooperative_stock_incoming_shippments_report', 'stock.picking', 'cooperative_stock/report/co_operative_incoming_shippment.rml' ,parser=stock_cooperative_incoming_shippments_report,header=False)
