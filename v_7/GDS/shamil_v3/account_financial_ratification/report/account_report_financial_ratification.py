...
report_sxw.report_sxw('report.account.account.financial.ratification', 'account.voucher', 'addons/account_financial_ratification/report/account_report_financial_ratification.rml', parser=account_financial_ratification, header=False)
