...
class return_12C(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(return_12C, self).__init__(cr, uid, name, context=context)
    ...
    def _getdata(self,pick):
        self.cr.execute("""
               select
                    ...
                    from asset_custody_line sm
                    left join asset_custody sp on (sm.picking_id=sp.id)
...
report_sxw.report_sxw('report.return_12C', 'asset.custody', 'addons/account_asset_custody_niss/report/return_12C.rml' ,parser=return_12C,header=False)
