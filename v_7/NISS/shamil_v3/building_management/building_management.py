...
class building_building(orm.Model):
    """
    To manage building and its operations"""
    
    def name_get(self, cr, uid, ids, context=None):
        """
        Override to read parent id of building.
        
        @return: Dictionary of building name
        """
        if context is None:
            context = {}
        if not ids:
    ...
    def _total_price(self, cr, uid, ids, field_name, arg, context={}):
        """ 
        Functional field function to finds the the total of price.
    ...
    def _building_name_get_fnc(self, cr, uid, ids, field_name, arg, context={}):
        """
        Functional field function to read name get value into the complete_name field.

        @return: Dictionary of complete_name value
        """
    ...
    def _get_image(self, cr, uid, ids, name, args, context=None):
        """
        To get bulding image.

        @retuen: list of object images 
        """
    ...
    def _set_image(self, cr, uid, id, name, value, args, context=None):
        """
        To set building image.
        
        @param name: building name
        @return: self write() method
        """
    ...
    def _check_recursion(self, cr, uid, ids, context=None):
        """
        Constrain function to restrict buildings and avoid recursive.
...
class item_item(orm.Model):
    """ 
    To manage items and its operation """
    ...
    def name_get(self, cr, uid, ids, context=None):
        """
        Override to add item code to search.

        @return: list of items ids and names
        """
        if not len(ids):
            return []
        res = []
...
class building_item(orm.Model):
    ...
    def onchange_item_id(self, cr, uid, ids, item_id ):
        """
        On change product function to read product name 
