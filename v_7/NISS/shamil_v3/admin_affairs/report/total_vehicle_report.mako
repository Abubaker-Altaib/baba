							...
							%if not data['form']['vehicle_type'] or data['form']['vehicle_type'] == 'non-state':
								%if not data['form']['place_id']:
									<tr >
										...
										<td><p >${l['model_name']}</p></td>
										<td><p >${l['department_name'] and l['department_name'].strip() or ''}</p></td>
										<td><p >${ (data['form']['employee_id'] and data['form']['employee_degree']) or (l['employee_degree'] and l['employee_degree']) or (l['driver_degree'] and l['driver_degree']) or (l['old_system_degree'] and l['old_system_degree']) or '' }</p></td>
										<td><p >${ (data['form']['employee_id'] and data['form']['employee_name']) or (l['employee_name'] and l['employee_name']) or (l['driver_name'] and l['driver_name']) or (l['old_system_driver'] and l['old_system_driver']) or '' }</p></td>
										<td><p >${l['use_name']}</p></td>
									</tr>
								%endif
								%if data['form']['place_id']:
