...
class stock_partial_picking_po_inhirt_custom(osv.osv_memory):
    """ 
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        res = super(stock_partial_picking_po_inhirt_custom, self).default_get(cr, uid, fields, context=context)
...
class stock_partial_move_po_inhirt_custom(osv.osv_memory):
    """ 
    To add clearance price to the product price unit """
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        if context is None:
            context = {}
        res = super(stock_partial_move_po_inhirt_custom, self).default_get(cr, uid, fields, context=context)
