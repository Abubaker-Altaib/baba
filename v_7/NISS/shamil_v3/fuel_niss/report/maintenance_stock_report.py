...
report_sxw.report_sxw('report.maintenance_stock_report','stock.picking','addons/fuel_niss/report/maintenance_stock_report.rml',parser=maintenance_stock_report, header=True)
