...
class purchase_line_invoice(osv.osv_memory):
    ...
    """ To create purchase invoices pure lines in the form of purchase order line """
        ...
        if record_ids:
            ...
            def multiple_order_invoice_notes(orders):
                ...
                for order in orders:
                    notes += "%s \n" % order.notes
                return notes
#  Edit this function to get currency from order company not from pricelist currency 
            def make_invoice_by_partner(partner, orders, lines_ids):
                ...
                inv = {
                    ...
                    'currency_id' : orders[0].company_id.currency_id.id,
