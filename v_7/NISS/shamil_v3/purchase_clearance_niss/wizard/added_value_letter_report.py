...
class added_value_letter_report(osv.osv_memory):
    _name = "added.value.letter.report"
    _description = "Added Value Letter Report"
    ...
    _columns = {
        ...
        'request_clearance_ids': fields.many2many('purchase.clearance','added_value_letter_wizard_rel','counter','request_id', string='Requests'), 
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        return {
            ...
            'report_name': 'added_value_letter_report',
            'datas': datas,
            }
