...
class port_fee_letter_report(osv.osv_memory):
    _name = "port.fee.letter.report"
    _description = "Port Fee Letter Report"
    ...
    _columns = {
        ...
        'request_clearance_ids': fields.many2many('purchase.clearance','port_fee_letter_wizard_rel','counter','request_id', string='Requests'), 
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        return {
            ...
            'report_name': 'port_fee_letter_report',
            'datas': datas,
            }
