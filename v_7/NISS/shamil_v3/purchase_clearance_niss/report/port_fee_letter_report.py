...
class port_fee_letter_report(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(port_fee_letter_report, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.port_fee_letter_report', 'purchase.clearance', 'purchase_clearance_niss/report/port_fee_letter_report.rml', parser=port_fee_letter_report,header=False)
