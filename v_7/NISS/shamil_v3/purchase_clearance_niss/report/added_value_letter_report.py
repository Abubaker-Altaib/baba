...
class added_value_letter_report(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(added_value_letter_report, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.added_value_letter_report', 'purchase.clearance', 'purchase_clearance_niss/report/added_value_letter_report.rml', parser=added_value_letter_report,header=False)
