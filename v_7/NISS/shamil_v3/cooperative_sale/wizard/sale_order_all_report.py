...
class sale_order_all_report(osv.osv_memory):
    ...
    _columns = {
        ...
        'scale_id' : fields.many2one('hr.salary.scale' ,'Report Type',select=True,),
        ...
        'report_type': fields.selection([('deliver', 'Delivery Report'),('statistical', 'Statistical Report'),('deduction', 'Deduction Report'),], 'Report type',select=True,readonly=True),
