...
class account_budget_cash_flow_wizard(osv.osv_memory):
    ...
    def onchange_company_id(self, cr, uid, ids, company_id, context=None):
        ...
        @return: dictionary of values of fields to be updated
        """
        return {'value': {'fiscalyear_id': self._get_fiscalyear_id(cr, uid, company_id, context=context), 'analytic_account_ids': False, 'account_ids': False, 'period_ids': False}}
    ...
    def compute(self, cr, uid, ids, context=None):
        ...
        fiscalyear_budget_pool.budget_validate(cr, uid, FY_budget_ids, period_ids, account_ids,context=context )
        
        return {'type':'ir.actions.act_window_close'}
    
account_budget_cash_flow_wizard()
