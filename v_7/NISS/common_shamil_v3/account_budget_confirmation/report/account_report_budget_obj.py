...
report_sxw.report_sxw('report.account.account.budget.object1', 'account.budget', 'addons/account_budget_confirmation/report/account_report_budget_obj.rml', parser=account_budget_object, header='custom landscape')
