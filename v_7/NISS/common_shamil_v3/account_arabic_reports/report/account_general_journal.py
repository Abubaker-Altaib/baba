...
class journal_print(report_sxw.rml_parse, common_report_header):
    ...
    def lines(self, period_id):
        ...
        self.cr.execute('SELECT j.code, j.name, l.amount_currency,c.symbol AS currency_code,l.currency_id, '
                        ...
                        'WHERE l.period_id=%s ' + self.state_query + ' AND l.journal_id IN %s ' + self.query_get_clause + ' '
...
report_sxw.report_sxw('report.account.general.journal.arabic', 'account.journal.period', 'addons/account_arabic_reports/report/account_general_journal.rml', parser=journal_print, header='external')
