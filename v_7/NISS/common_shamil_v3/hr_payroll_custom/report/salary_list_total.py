...
class salary_list_total(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        ...
        self.total = {'sheat1':0.0, 'sheat2':0.0,'deductions':0.0,'taxs':0.0,'net':0}
    ...
    def _process(self,data):
        ...
        self.cr.execute('''SELECT emp.id,emp.name_related AS emp_name,emp.emp_code AS emp_code, 
                           pm.tax AS tax,pm.total_deduction AS deductions,pm.total_loans AS loans,pm.basic_salary AS basic,pm.net as net,
                           sum(
                           ...
                           pm.tax ,pm.total_deduction ,pm.total_loans,pm.basic_salary,pm.net''',(year,month))
