...
class hr_config_settings_inherit(osv.osv_memory):
    ...
    _columns = {
          ...
          'payroll_journal_id':fields.related('company_id','payroll_journal_id',type='many2one', relation='account.journal',string='Payroll Journal' ),
          'payroll_account_id':fields.related('company_id','payroll_account_id',type='many2one', relation='account.account',string='Payroll Account',domain="[('type','!=','view')]"),
    }
    ...
    def onchange_company_id(self, cr, uid, ids, company_id, context=None):
        ...
        if company_id:
            ...
            values = {
                ...
                'payroll_journal_id': company.payroll_journal_id and company.payroll_journal_id.id or False,
                'payroll_account_id': company.payroll_account_id and company.payroll_account_id.id or False,
            }
