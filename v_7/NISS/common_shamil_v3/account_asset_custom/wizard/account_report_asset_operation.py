...
class account_report_asset_list(osv.osv_memory):
    ...
    def check_report(self, cr, uid, ids, context=None):
        ...
        data['form'] = self.read(cr, uid, ids, ['company_id','category_id','filter','date_from', 'date_to','asset_lists', 'revalue_asset','depreciation_value','sale_value','addition_value','abandon_asset','filter_by_date'])[0]        
