...
class account_asset_location(osv.osv):
    """ Object of to configure location to be used by the asset object"""
    ...
    _sql_constraints = [
        ('code_company_uniq', 'unique (code,company_id)', 'The code of the location must be unique per company !')
    ]
