...
class promotion_group_by_job(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(promotion_group_by_job, self).__init__(cr, uid, name, context)
        self.all_data = []
...
report_sxw.report_sxw('report.promotion_group_by_job.report', 'hr.movements.degree',
                      'addons/hr_custom_military/report/promotion_group_by_job.rml', parser=promotion_group_by_job, header='internal landscape')
