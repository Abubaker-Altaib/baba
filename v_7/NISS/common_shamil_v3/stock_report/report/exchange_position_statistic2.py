...
class exchange_position_statistic2(report_sxw.rml_parse):
      def __init__(self, cr, uid, name, context):
        super(exchange_position_statistic2, self).__init__(cr, uid, name, context)
...
report_sxw.report_sxw('report.exchange_position_statistic_report2', 'stock.picking', 'addons/stock_report/report/exchange_position_statistic2.rml' ,parser=exchange_position_statistic2,header='internal landscape')
