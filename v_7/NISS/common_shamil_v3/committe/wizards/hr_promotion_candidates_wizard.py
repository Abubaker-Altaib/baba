...
#----------------------------------------
class promotions_candidates(osv.osv_memory):
    _inherit = 'hr.promotions.candidates'
                        ...
                        if new_degree_id:
                            for new_degree in salary_degree_obj.browse(cr,uid,new_degree_id,context=context):
                                for employee in employee_obj.browse(cr,uid,employee_ids,context=context):
                                    ...
                                    if days <= c.margin :
                                        degree_obj = salary_degree_obj.browse(cr , uid , [new_degree.id])[0]
                                        ...
                                        emp_degree_dict = {
                                             ...
                                             'is_committe': c.is_committe,
                                             'process_type':'promotion',
                                             'new_scale_id' :  employee.payroll_id.id ,
